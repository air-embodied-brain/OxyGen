...
class Pi05Config(_model.BaseModelConfig):
    ...
    language_adapter: Literal["none", "final_mlp", "suffix_lora", "full_lora"] = "none"
    ...
    def __post_init__(self):
        ...
        if self.language_adapter != "none" and not self.language_suffix_adapter_rank:
            raise ValueError("language_suffix_adapter_rank must be positive when a language adapter is enabled")
    ...
    def model_type(self) -> _model.ModelType:
        return _model.ModelType.PI05_O2
